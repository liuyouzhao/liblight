...
//			} else {
//				fileInputStream = new FileInputStream(cachedSites);
...
//			} else {
//				fileInputStream = new FileInputStream(blockedSitesTxtFile);
//				objectInputStream = new ObjectInputStream(fileInputStream);
	...
	public void listen(){
		...
		while(running){
			try {
				...
				Thread thread = new Thread(new RequestProcessorCore(socket));
